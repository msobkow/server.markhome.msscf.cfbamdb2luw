// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for PopSubDep1.
...
/*
 *	CFBamDb2LUWPopSubDep1Table DB/2 LUW Jdbc DbIO implementation
 *	for PopSubDep1.
 */
	...
	implements ICFBamPopSubDep1Table
{
		...
		long PopTopDepId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_popsubdep1_by_poptopdepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamPopSubDep1Buff Buff )
	{
		...
		if( "a831".equals( Buff.getClassCode() )
		...
		long argPopTopDepId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_popsubdep1_by_poptopdepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
