// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DelSubDep3.
...
/*
 *	CFBamDb2LUWDelSubDep3Table DB/2 LUW Jdbc DbIO implementation
 *	for DelSubDep3.
 */
	...
	implements ICFBamDelSubDep3Table
{
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_delsubdep3_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long DelSubDep2Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_delsubdep3_by_delsubdep2idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamDelSubDep3Buff Buff )
	{
		...
		if( "a81a".equals( Buff.getClassCode() )
		...
		long argDelSubDep2Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_delsubdep3_by_delsubdep2idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argRelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_delsubdep3_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
