// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for FloatCol.
...
/*
 *	CFBamDb2LUWFloatColTable DB/2 LUW Jdbc DbIO implementation
 *	for FloatCol.
 */
	...
	implements ICFBamFloatColTable
{
		...
		CFBamFloatColBuff Buff )
	{
		...
		if( "a858".equals( Buff.getClassCode() )
