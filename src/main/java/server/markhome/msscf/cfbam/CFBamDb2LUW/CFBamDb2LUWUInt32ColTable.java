// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UInt32Col.
...
/*
 *	CFBamDb2LUWUInt32ColTable DB/2 LUW Jdbc DbIO implementation
 *	for UInt32Col.
 */
	...
	implements ICFBamUInt32ColTable
{
		...
		CFBamUInt32ColBuff Buff )
	{
		...
		if( "a86b".equals( Buff.getClassCode() )
