// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DelTopDep.
...
/*
 *	CFBamDb2LUWDelTopDepTable DB/2 LUW Jdbc DbIO implementation
 *	for DelTopDep.
 */
	...
	implements ICFBamDelTopDepTable
{
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_del_topdep_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_del_topdep_by_deltopdeptblidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long PrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_del_topdep_by_previdx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long NextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_del_topdep_by_nextidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamDelTopDepBuff Buff )
	{
		...
		if( "a81b".equals( Buff.getClassCode() )
		...
		long argTableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_del_topdep_by_deltopdeptblidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long argPrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_del_topdep_by_previdx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long argNextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_del_topdep_by_nextidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argRelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_del_topdep_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		int revision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_moveup_del_topdep( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", ? )";
			if( stmtMoveUp == null ) {
		...
		int revision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_movedown_del_topdep( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", ? )";
