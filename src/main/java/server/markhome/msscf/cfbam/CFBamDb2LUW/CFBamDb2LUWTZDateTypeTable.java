// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TZDateType.
...
/*
 *	CFBamDb2LUWTZDateTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for TZDateType.
 */
	...
	implements ICFBamTZDateTypeTable
{
		...
		CFBamTZDateTypeBuff Buff )
	{
		...
		if( "a83b".equals( Buff.getClassCode() )
