// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Int16Def.
...
/*
 *	CFBamDb2LUWInt16DefTable DB/2 LUW Jdbc DbIO implementation
 *	for Int16Def.
 */
	...
	implements ICFBamInt16DefTable
{
		...
		CFBamInt16DefBuff Buff )
	{
		...
		if( "a823".equals( Buff.getClassCode() )
