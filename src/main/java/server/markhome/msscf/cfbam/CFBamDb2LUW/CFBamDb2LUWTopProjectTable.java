// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TopProject.
...
/*
 *	CFBamDb2LUWTopProjectTable DB/2 LUW Jdbc DbIO implementation
 *	for TopProject.
 */
	...
	implements ICFBamTopProjectTable
{
		...
		long TopDomainId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_tprjdef_by_topdomainidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFIntTopProjectBuff Buff )
	{
		...
		if( "a108".equals( Buff.getClassCode() )
		...
		long argTopDomainId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_tprjdef_by_topdomainidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
