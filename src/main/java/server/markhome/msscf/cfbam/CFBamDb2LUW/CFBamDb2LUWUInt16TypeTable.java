// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UInt16Type.
...
/*
 *	CFBamDb2LUWUInt16TypeTable DB/2 LUW Jdbc DbIO implementation
 *	for UInt16Type.
 */
	...
	implements ICFBamUInt16TypeTable
{
		...
		CFBamUInt16TypeBuff Buff )
	{
		...
		if( "a84b".equals( Buff.getClassCode() )
