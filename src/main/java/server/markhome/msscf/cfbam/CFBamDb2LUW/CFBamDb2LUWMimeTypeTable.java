// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for MimeType.
...
/*
 *	CFBamDb2LUWMimeTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for MimeType.
 */
	...
	implements ICFBamMimeTypeTable
{
		...
		CFIntMimeTypeBuff Buff )
	{
		...
		if( "a103".equals( Buff.getClassCode() )
