// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DoubleCol.
...
/*
 *	CFBamDb2LUWDoubleColTable DB/2 LUW Jdbc DbIO implementation
 *	for DoubleCol.
 */
	...
	implements ICFBamDoubleColTable
{
		...
		CFBamDoubleColBuff Buff )
	{
		...
		if( "a855".equals( Buff.getClassCode() )
