// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DoubleDef.
...
/*
 *	CFBamDb2LUWDoubleDefTable DB/2 LUW Jdbc DbIO implementation
 *	for DoubleDef.
 */
	...
	implements ICFBamDoubleDefTable
{
		...
		CFBamDoubleDefBuff Buff )
	{
		...
		if( "a81c".equals( Buff.getClassCode() )
