// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TZTimestampType.
...
/*
 *	CFBamDb2LUWTZTimestampTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for TZTimestampType.
 */
	...
	implements ICFBamTZTimestampTypeTable
{
		...
		CFBamTZTimestampTypeBuff Buff )
	{
		...
		if( "a83f".equals( Buff.getClassCode() )
