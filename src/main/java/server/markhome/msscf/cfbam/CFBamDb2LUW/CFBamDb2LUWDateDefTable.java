// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DateDef.
...
/*
 *	CFBamDb2LUWDateDefTable DB/2 LUW Jdbc DbIO implementation
 *	for DateDef.
 */
	...
	implements ICFBamDateDefTable
{
		...
		CFBamDateDefBuff Buff )
	{
		...
		if( "a815".equals( Buff.getClassCode() )
