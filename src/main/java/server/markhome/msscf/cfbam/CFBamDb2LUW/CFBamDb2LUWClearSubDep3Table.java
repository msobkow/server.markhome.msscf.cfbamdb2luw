// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ClearSubDep3.
...
/*
 *	CFBamDb2LUWClearSubDep3Table DB/2 LUW Jdbc DbIO implementation
 *	for ClearSubDep3.
 */
	...
	implements ICFBamClearSubDep3Table
{
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clrsubdep3_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long DefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clrsubdep3_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long ClearSubDep2Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clrsubdep3_by_clearsubdep2idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamClearSubDep3Buff Buff )
	{
		...
		if( "a813".equals( Buff.getClassCode() )
		...
		long argClearSubDep2Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clrsubdep3_by_clearsubdep2idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argRelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clrsubdep3_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long argDefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clrsubdep3_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
