// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for BoolCol.
...
/*
 *	CFBamDb2LUWBoolColTable DB/2 LUW Jdbc DbIO implementation
 *	for BoolCol.
 */
	...
	implements ICFBamBoolColTable
{
		...
		CFBamBoolColBuff Buff )
	{
		...
		if( "a853".equals( Buff.getClassCode() )
