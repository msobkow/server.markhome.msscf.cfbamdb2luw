// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Int32Type.
...
/*
 *	CFBamDb2LUWInt32TypeTable DB/2 LUW Jdbc DbIO implementation
 *	for Int32Type.
 */
	...
	implements ICFBamInt32TypeTable
{
		...
		CFBamInt32TypeBuff Buff )
	{
		...
		if( "a826".equals( Buff.getClassCode() )
