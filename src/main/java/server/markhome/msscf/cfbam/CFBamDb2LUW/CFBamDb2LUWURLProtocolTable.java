// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for URLProtocol.
...
/*
 *	CFBamDb2LUWURLProtocolTable DB/2 LUW Jdbc DbIO implementation
 *	for URLProtocol.
 */
	...
	implements ICFBamURLProtocolTable
{
		...
		CFIntURLProtocolBuff Buff )
	{
		...
		if( "a109".equals( Buff.getClassCode() )
