// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Relation.
...
/*
 *	CFBamDb2LUWRelationTable DB/2 LUW Jdbc DbIO implementation
 *	for Relation.
 */
	...
	implements ICFBamRelationTable
{
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_reldef_by_reltableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamRelationBuff Buff )
	{
		...
		if( "a835".equals( Buff.getClassCode() )
		...
		long argTableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_reldef_by_reltableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
