// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UInt64Def.
...
/*
 *	CFBamDb2LUWUInt64DefTable DB/2 LUW Jdbc DbIO implementation
 *	for UInt64Def.
 */
	...
	implements ICFBamUInt64DefTable
{
		...
		CFBamUInt64DefBuff Buff )
	{
		...
		if( "a84e".equals( Buff.getClassCode() )
