// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for PopTopDep.
...
/*
 *	CFBamDb2LUWPopTopDepTable DB/2 LUW Jdbc DbIO implementation
 *	for PopTopDep.
 */
	...
	implements ICFBamPopTopDepTable
{
		...
		CFBamPopTopDepBuff Buff )
	{
		...
		if( "a834".equals( Buff.getClassCode() )
