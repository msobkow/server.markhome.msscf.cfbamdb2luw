// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UInt32Type.
...
/*
 *	CFBamDb2LUWUInt32TypeTable DB/2 LUW Jdbc DbIO implementation
 *	for UInt32Type.
 */
	...
	implements ICFBamUInt32TypeTable
{
		...
		CFBamUInt32TypeBuff Buff )
	{
		...
		if( "a84d".equals( Buff.getClassCode() )
