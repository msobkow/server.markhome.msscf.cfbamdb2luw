// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DelDep.
...
/*
 *	CFBamDb2LUWDelDepTable DB/2 LUW Jdbc DbIO implementation
 *	for DelDep.
 */
	...
	implements ICFBamDelDepTable
{
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_del_dep_cc_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_del_dep_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamDelDepBuff Buff )
	{
		...
		if( "a817".equals( Buff.getClassCode() )
		...
		long argRelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_del_dep_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
