// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Int16Type.
...
/*
 *	CFBamDb2LUWInt16TypeTable DB/2 LUW Jdbc DbIO implementation
 *	for Int16Type.
 */
	...
	implements ICFBamInt16TypeTable
{
		...
		CFBamInt16TypeBuff Buff )
	{
		...
		if( "a824".equals( Buff.getClassCode() )
