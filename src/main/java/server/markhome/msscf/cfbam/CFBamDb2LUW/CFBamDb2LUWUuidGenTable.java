// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UuidGen.
...
/*
 *	CFBamDb2LUWUuidGenTable DB/2 LUW Jdbc DbIO implementation
 *	for UuidGen.
 */
	...
	implements ICFBamUuidGenTable
{
		...
		CFBamUuidGenBuff Buff )
	{
		...
		if( "a86e".equals( Buff.getClassCode() )
