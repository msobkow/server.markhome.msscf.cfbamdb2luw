// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for MinorVersion.
...
/*
 *	CFBamDb2LUWMinorVersionTable DB/2 LUW Jdbc DbIO implementation
 *	for MinorVersion.
 */
	...
	implements ICFBamMinorVersionTable
{
		...
		CFIntMinorVersionPKey PKey )
	{
		...
		try {
			...
			final String sql = "CALL sp_read_mnvrdef( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFIntMinorVersionPKey PKey )
	{
		...
		try {
			...
			long TenantId = PKey.getRequiredTenantId();
			long Id = PKey.getRequiredId();
			final String sql = "CALL sp_lock_mnvrdef( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
	...
	public CFIntMinorVersionBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mnvrdef_all( ?, ?, ?, ?, ? )";
		...
		long Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mnvrdef_by_ididx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long TenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mnvrdef_by_tenantidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + " )";
		...
		long MajorVersionId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mnvrdef_by_majorveridx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		String Name )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mnvrdef_by_nameidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFIntMinorVersionBuff Buff )
	{
		...
		if( "a104".equals( Buff.getClassCode() )
		...
		CFIntMinorVersionBuff Buff )
	{
		...
		try {
			...
			final String sql = "CALL sp_delete_mnvrdef( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_mnvrdef_by_ididx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argTenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_mnvrdef_by_tenantidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + " )";
		...
		long argMajorVersionId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_mnvrdef_by_majorveridx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		String argName )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_mnvrdef_by_nameidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
