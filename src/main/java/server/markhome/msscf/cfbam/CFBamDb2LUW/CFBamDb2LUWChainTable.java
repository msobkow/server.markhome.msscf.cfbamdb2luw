// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Chain.
...
/*
 *	CFBamDb2LUWChainTable DB/2 LUW Jdbc DbIO implementation
 *	for Chain.
 */
	...
	implements ICFBamChainTable
{
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_chain_def_by_chaintableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamChainBuff Buff )
	{
		...
		if( "a80f".equals( Buff.getClassCode() )
		...
		long argTableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_chain_def_by_chaintableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
