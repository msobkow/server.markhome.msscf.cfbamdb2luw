// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for SysCluster.
...
/*
 *	CFBamDb2LUWSysClusterTable DB/2 LUW Jdbc DbIO implementation
 *	for SysCluster.
 */
	...
	implements ICFBamSysClusterTable
{
		...
		CFSecSysClusterBuff Buff )
	{
		...
		if( "a014".equals( Buff.getClassCode() )
