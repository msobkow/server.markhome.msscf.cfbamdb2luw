// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UInt16Col.
...
/*
 *	CFBamDb2LUWUInt16ColTable DB/2 LUW Jdbc DbIO implementation
 *	for UInt16Col.
 */
	...
	implements ICFBamUInt16ColTable
{
		...
		CFBamUInt16ColBuff Buff )
	{
		...
		if( "a86a".equals( Buff.getClassCode() )
