// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for NumberCol.
...
/*
 *	CFBamDb2LUWNumberColTable DB/2 LUW Jdbc DbIO implementation
 *	for NumberCol.
 */
	...
	implements ICFBamNumberColTable
{
		...
		CFBamNumberColBuff Buff )
	{
		...
		if( "a861".equals( Buff.getClassCode() )
