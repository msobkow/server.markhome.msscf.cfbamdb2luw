// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TextCol.
...
/*
 *	CFBamDb2LUWTextColTable DB/2 LUW Jdbc DbIO implementation
 *	for TextCol.
 */
	...
	implements ICFBamTextColTable
{
		...
		CFBamTextColBuff Buff )
	{
		...
		if( "a866".equals( Buff.getClassCode() )
