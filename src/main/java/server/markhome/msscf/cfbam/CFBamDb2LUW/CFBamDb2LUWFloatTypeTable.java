// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for FloatType.
...
/*
 *	CFBamDb2LUWFloatTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for FloatType.
 */
	...
	implements ICFBamFloatTypeTable
{
		...
		CFBamFloatTypeBuff Buff )
	{
		...
		if( "a820".equals( Buff.getClassCode() )
