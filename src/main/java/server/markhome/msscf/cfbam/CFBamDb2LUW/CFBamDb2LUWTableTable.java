// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Table.
...
/*
 *	CFBamDb2LUWTableTable DB/2 LUW Jdbc DbIO implementation
 *	for Table.
 */
	...
	implements ICFBamTableTable
{
		...
		CFBamTableBuff Buff )
	{
		...
		if( "a808".equals( Buff.getClassCode() )
