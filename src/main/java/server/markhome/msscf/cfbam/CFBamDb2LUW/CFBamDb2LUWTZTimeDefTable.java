// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TZTimeDef.
...
/*
 *	CFBamDb2LUWTZTimeDefTable DB/2 LUW Jdbc DbIO implementation
 *	for TZTimeDef.
 */
	...
	implements ICFBamTZTimeDefTable
{
		...
		CFBamTZTimeDefBuff Buff )
	{
		...
		if( "a83c".equals( Buff.getClassCode() )
