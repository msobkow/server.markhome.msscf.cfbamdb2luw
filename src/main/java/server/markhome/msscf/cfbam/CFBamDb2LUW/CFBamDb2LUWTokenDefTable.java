// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TokenDef.
...
/*
 *	CFBamDb2LUWTokenDefTable DB/2 LUW Jdbc DbIO implementation
 *	for TokenDef.
 */
	...
	implements ICFBamTokenDefTable
{
		...
		CFBamTokenDefBuff Buff )
	{
		...
		if( "a848".equals( Buff.getClassCode() )
