// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DateCol.
...
/*
 *	CFBamDb2LUWDateColTable DB/2 LUW Jdbc DbIO implementation
 *	for DateCol.
 */
	...
	implements ICFBamDateColTable
{
		...
		CFBamDateColBuff Buff )
	{
		...
		if( "a854".equals( Buff.getClassCode() )
