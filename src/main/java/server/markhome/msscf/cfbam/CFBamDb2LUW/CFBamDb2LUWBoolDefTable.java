// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for BoolDef.
...
/*
 *	CFBamDb2LUWBoolDefTable DB/2 LUW Jdbc DbIO implementation
 *	for BoolDef.
 */
	...
	implements ICFBamBoolDefTable
{
		...
		CFBamBoolDefBuff Buff )
	{
		...
		if( "a80d".equals( Buff.getClassCode() )
