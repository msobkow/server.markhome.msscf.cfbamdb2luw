// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TZTimestampDef.
...
/*
 *	CFBamDb2LUWTZTimestampDefTable DB/2 LUW Jdbc DbIO implementation
 *	for TZTimestampDef.
 */
	...
	implements ICFBamTZTimestampDefTable
{
		...
		CFBamTZTimestampDefBuff Buff )
	{
		...
		if( "a83e".equals( Buff.getClassCode() )
