// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TSecGrpInc.
...
/*
 *	CFBamDb2LUWTSecGrpIncTable DB/2 LUW Jdbc DbIO implementation
 *	for TSecGrpInc.
 */
public class CFBamDb2LUWTSecGrpIncTable
	implements ICFBamTSecGrpIncTable
{
	...
	public CFBamDb2LUWTSecGrpIncTable( CFBamDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpIncId )
	{
		final String S_ProcName = "CFBamDb2LUWTSecGrpIncTable.readDerivedByIdIdx() ";
		CFSecTSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFBamDb2LUWTSecGrpIncTable.readDerivedByUIncludeIdx() ";
		CFSecTSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		Long priorTSecGrpIncId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_page_tsecinc_all( ?, ?, ?, ?, ?, ?, ? )";
		...
		Long priorTSecGrpIncId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_page_tsecinc_by_tenantidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long priorTSecGrpIncId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_page_tsecinc_by_groupidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long priorTSecGrpIncId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_page_tsecinc_by_includeidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFSecTSecGrpIncBuff Buff )
	{
		...
		if( "a017".equals( Buff.getClassCode() )
				...
				"UpdateTSecGrpInc" ) ) )
		{
			throw new CFLibRuntimeException( getClass(),
				S_ProcName,
				"Permission denied -- User not part of TSecGroup UpdateTSecGrpInc" );
		}
		ResultSet resultSet = null;
		try {
			long TenantId = Buff.getRequiredTenantId();
