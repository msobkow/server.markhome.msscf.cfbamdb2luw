// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TZTimeCol.
...
/*
 *	CFBamDb2LUWTZTimeColTable DB/2 LUW Jdbc DbIO implementation
 *	for TZTimeCol.
 */
	...
	implements ICFBamTZTimeColTable
{
		...
		CFBamTZTimeColBuff Buff )
	{
		...
		if( "a864".equals( Buff.getClassCode() )
