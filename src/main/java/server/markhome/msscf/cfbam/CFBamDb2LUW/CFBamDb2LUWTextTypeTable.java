// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TextType.
...
/*
 *	CFBamDb2LUWTextTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for TextType.
 */
	...
	implements ICFBamTextTypeTable
{
		...
		CFBamTextTypeBuff Buff )
	{
		...
		if( "a842".equals( Buff.getClassCode() )
