// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TZTimeType.
...
/*
 *	CFBamDb2LUWTZTimeTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for TZTimeType.
 */
	...
	implements ICFBamTZTimeTypeTable
{
		...
		CFBamTZTimeTypeBuff Buff )
	{
		...
		if( "a83d".equals( Buff.getClassCode() )
