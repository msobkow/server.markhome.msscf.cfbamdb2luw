// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ClearTopDep.
...
/*
 *	CFBamDb2LUWClearTopDepTable DB/2 LUW Jdbc DbIO implementation
 *	for ClearTopDep.
 */
	...
	implements ICFBamClearTopDepTable
{
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clr_topdep_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long DefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clr_topdep_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clr_topdep_by_clrtopdeptblidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long PrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clr_topdep_by_previdx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long NextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clr_topdep_by_nextidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamClearTopDepBuff Buff )
	{
		...
		if( "a814".equals( Buff.getClassCode() )
		...
		long argTableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clr_topdep_by_clrtopdeptblidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long argPrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clr_topdep_by_previdx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long argNextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clr_topdep_by_nextidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argRelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clr_topdep_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long argDefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clr_topdep_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		int revision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_moveup_clr_topdep( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", ? )";
			if( stmtMoveUp == null ) {
		...
		int revision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_movedown_clr_topdep( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", ? )";
