// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Scope.
...
/*
 *	CFBamDb2LUWScopeTable DB/2 LUW Jdbc DbIO implementation
 *	for Scope.
 */
	...
	implements ICFBamScopeTable
{
		...
		CFBamScopeBuff Buff )
	{
		...
		if( "a801".equals( Buff.getClassCode() )
