// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DoubleType.
...
/*
 *	CFBamDb2LUWDoubleTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for DoubleType.
 */
	...
	implements ICFBamDoubleTypeTable
{
		...
		CFBamDoubleTypeBuff Buff )
	{
		...
		if( "a81d".equals( Buff.getClassCode() )
