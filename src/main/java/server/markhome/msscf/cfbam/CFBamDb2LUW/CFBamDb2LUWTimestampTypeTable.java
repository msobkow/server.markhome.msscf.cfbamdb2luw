// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TimestampType.
...
/*
 *	CFBamDb2LUWTimestampTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for TimestampType.
 */
	...
	implements ICFBamTimestampTypeTable
{
		...
		CFBamTimestampTypeBuff Buff )
	{
		...
		if( "a847".equals( Buff.getClassCode() )
