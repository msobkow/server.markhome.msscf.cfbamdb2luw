// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for PopDep.
...
/*
 *	CFBamDb2LUWPopDepTable DB/2 LUW Jdbc DbIO implementation
 *	for PopDep.
 */
	...
	implements ICFBamPopDepTable
{
		...
		CFBamPopDepBuff Buff )
	{
		...
		if( "a830".equals( Buff.getClassCode() )
