// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TableCol.
...
/*
 *	CFBamDb2LUWTableColTable DB/2 LUW Jdbc DbIO implementation
 *	for TableCol.
 */
	...
	implements ICFBamTableColTable
{
		...
		CFBamTableColBuff Buff )
	{
		...
		if( "a840".equals( Buff.getClassCode() )
