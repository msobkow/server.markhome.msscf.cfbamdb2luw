// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Index.
...
/*
 *	CFBamDb2LUWIndexTable DB/2 LUW Jdbc DbIO implementation
 *	for Index.
 */
	...
	implements ICFBamIndexTable
{
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_idxdef_by_idxtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamIndexBuff Buff )
	{
		...
		if( "a821".equals( Buff.getClassCode() )
		...
		long argTableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_idxdef_by_idxtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
