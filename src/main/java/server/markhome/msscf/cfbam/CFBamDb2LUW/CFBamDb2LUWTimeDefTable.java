// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TimeDef.
...
/*
 *	CFBamDb2LUWTimeDefTable DB/2 LUW Jdbc DbIO implementation
 *	for TimeDef.
 */
	...
	implements ICFBamTimeDefTable
{
		...
		CFBamTimeDefBuff Buff )
	{
		...
		if( "a843".equals( Buff.getClassCode() )
