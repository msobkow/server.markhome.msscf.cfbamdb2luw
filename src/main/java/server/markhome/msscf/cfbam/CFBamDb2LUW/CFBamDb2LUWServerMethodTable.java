// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ServerMethod.
...
/*
 *	CFBamDb2LUWServerMethodTable DB/2 LUW Jdbc DbIO implementation
 *	for ServerMethod.
 */
	...
	implements ICFBamServerMethodTable
{
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_srvmeth_cc_by_methtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_srvmeth_by_methtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamServerMethodBuff Buff )
	{
		...
		if( "a805".equals( Buff.getClassCode() )
		...
		long argTableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_srvmeth_by_methtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
