// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DelSubDep2.
...
/*
 *	CFBamDb2LUWDelSubDep2Table DB/2 LUW Jdbc DbIO implementation
 *	for DelSubDep2.
 */
	...
	implements ICFBamDelSubDep2Table
{
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_delsubdep2_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamDelSubDep2Buff Buff )
	{
		...
		if( "a819".equals( Buff.getClassCode() )
		...
		long argRelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_delsubdep2_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
