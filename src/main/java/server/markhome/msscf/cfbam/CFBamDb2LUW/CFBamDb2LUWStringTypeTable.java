// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for StringType.
...
/*
 *	CFBamDb2LUWStringTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for StringType.
 */
	...
	implements ICFBamStringTypeTable
{
	...
	throws SQLException
	{
		...
		idxcol++;
		buff.setRequiredIsPolymorph( ( "Y".equals( resultSet.getString( idxcol ) ) ? true : false ) );
		idxcol++;
		{
			String colVal = resultSet.getString( idxcol );
			if( resultSet.wasNull() ) {
		...
		CFBamStringTypeBuff Buff )
	{
		...
		if( "a839".equals( Buff.getClassCode() )
