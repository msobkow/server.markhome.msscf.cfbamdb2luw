// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TimeType.
...
/*
 *	CFBamDb2LUWTimeTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for TimeType.
 */
	...
	implements ICFBamTimeTypeTable
{
		...
		CFBamTimeTypeBuff Buff )
	{
		...
		if( "a845".equals( Buff.getClassCode() )
