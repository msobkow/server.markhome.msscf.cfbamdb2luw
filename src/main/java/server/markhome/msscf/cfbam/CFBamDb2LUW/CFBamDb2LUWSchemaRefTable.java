// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for SchemaRef.
...
/*
 *	CFBamDb2LUWSchemaRefTable DB/2 LUW Jdbc DbIO implementation
 *	for SchemaRef.
 */
	...
	implements ICFBamSchemaRefTable
{
		...
		Long PrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_schema_ref_by_previdx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long NextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_schema_ref_by_nextidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamSchemaRefBuff Buff )
	{
		...
		if( "a804".equals( Buff.getClassCode() )
		...
		Long argPrevId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_schema_ref_by_previdx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long argNextId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_schema_ref_by_nextidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		int revision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_moveup_schema_ref( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", ? )";
			if( stmtMoveUp == null ) {
		...
		int revision )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_movedown_schema_ref( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", ? )";
