// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Value.
...
/*
 *	CFBamDb2LUWValueTable DB/2 LUW Jdbc DbIO implementation
 *	for Value.
 */
	...
	implements ICFBamValueTable
{
		...
		CFBamValueBuff Buff )
	{
		...
		if( "a809".equals( Buff.getClassCode() )
