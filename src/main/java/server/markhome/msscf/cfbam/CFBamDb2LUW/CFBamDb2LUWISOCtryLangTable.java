...
/*
 *	CFBamDb2LUWISOCtryLangTable DB/2 LUW Jdbc DbIO implementation
 *	for ISOCtryLang.
 */
public class CFBamDb2LUWISOCtryLangTable
	implements ICFBamISOCtryLangTable
{
	...
	public CFBamDb2LUWISOCtryLangTable( CFBamDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOLangId )
	{
		final String S_ProcName = "CFBamDb2LUWISOCtryLangTable.readDerivedByIdIdx() ";
		CFSecISOCtryLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
