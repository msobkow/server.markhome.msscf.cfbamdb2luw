// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ClearSubDep2.
...
/*
 *	CFBamDb2LUWClearSubDep2Table DB/2 LUW Jdbc DbIO implementation
 *	for ClearSubDep2.
 */
	...
	implements ICFBamClearSubDep2Table
{
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clrsubdep2_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long DefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clrsubdep2_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long ClearSubDep1Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clrsubdep2_by_clearsubdep1idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamClearSubDep2Buff Buff )
	{
		...
		if( "a812".equals( Buff.getClassCode() )
		...
		long argClearSubDep1Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clrsubdep2_by_clearsubdep1idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argRelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clrsubdep2_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long argDefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clrsubdep2_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
