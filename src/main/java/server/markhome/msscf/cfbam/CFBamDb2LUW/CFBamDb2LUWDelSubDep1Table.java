// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for DelSubDep1.
...
/*
 *	CFBamDb2LUWDelSubDep1Table DB/2 LUW Jdbc DbIO implementation
 *	for DelSubDep1.
 */
	...
	implements ICFBamDelSubDep1Table
{
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_delsubdep1_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long DelTopDepId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_delsubdep1_by_deltopdepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamDelSubDep1Buff Buff )
	{
		...
		if( "a818".equals( Buff.getClassCode() )
		...
		long argDelTopDepId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_delsubdep1_by_deltopdepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argRelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_delsubdep1_by_deldepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
