// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for PopSubDep3.
...
/*
 *	CFBamDb2LUWPopSubDep3Table DB/2 LUW Jdbc DbIO implementation
 *	for PopSubDep3.
 */
	...
	implements ICFBamPopSubDep3Table
{
		...
		long PopSubDep2Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_popsubdep3_by_popsubdep2idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamPopSubDep3Buff Buff )
	{
		...
		if( "a833".equals( Buff.getClassCode() )
		...
		long argPopSubDep2Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_popsubdep3_by_popsubdep2idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
