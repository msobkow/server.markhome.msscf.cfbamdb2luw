...
/*
 *	CFBamDb2LUWSecGrpMembTable DB/2 LUW Jdbc DbIO implementation
 *	for SecGrpMemb.
 */
public class CFBamDb2LUWSecGrpMembTable
	implements ICFBamSecGrpMembTable
{
	...
	public CFBamDb2LUWSecGrpMembTable( CFBamDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpMembId )
	{
		final String S_ProcName = "CFBamDb2LUWSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFBamDb2LUWSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
