// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ServerProc.
...
/*
 *	CFBamDb2LUWServerProcTable DB/2 LUW Jdbc DbIO implementation
 *	for ServerProc.
 */
	...
	implements ICFBamServerProcTable
{
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_srvprc_by_methtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamServerProcBuff Buff )
	{
		...
		if( "a807".equals( Buff.getClassCode() )
		...
		long argTableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_srvprc_by_methtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
