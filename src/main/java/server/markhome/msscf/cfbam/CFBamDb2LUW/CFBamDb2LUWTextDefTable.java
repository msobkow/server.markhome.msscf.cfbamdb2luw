// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TextDef.
...
/*
 *	CFBamDb2LUWTextDefTable DB/2 LUW Jdbc DbIO implementation
 *	for TextDef.
 */
	...
	implements ICFBamTextDefTable
{
		...
		CFBamTextDefBuff Buff )
	{
		...
		if( "a841".equals( Buff.getClassCode() )
