// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TimestampDef.
...
/*
 *	CFBamDb2LUWTimestampDefTable DB/2 LUW Jdbc DbIO implementation
 *	for TimestampDef.
 */
	...
	implements ICFBamTimestampDefTable
{
		...
		CFBamTimestampDefBuff Buff )
	{
		...
		if( "a846".equals( Buff.getClassCode() )
