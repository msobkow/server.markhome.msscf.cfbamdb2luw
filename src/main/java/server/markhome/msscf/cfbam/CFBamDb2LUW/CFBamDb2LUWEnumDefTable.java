// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for EnumDef.
...
/*
 *	CFBamDb2LUWEnumDefTable DB/2 LUW Jdbc DbIO implementation
 *	for EnumDef.
 */
	...
	implements ICFBamEnumDefTable
{
		...
		CFBamEnumDefBuff Buff )
	{
		...
		if( "a856".equals( Buff.getClassCode() )
