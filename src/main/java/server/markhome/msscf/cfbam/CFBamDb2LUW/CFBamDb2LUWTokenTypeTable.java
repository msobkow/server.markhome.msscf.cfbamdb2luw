// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TokenType.
...
/*
 *	CFBamDb2LUWTokenTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for TokenType.
 */
	...
	implements ICFBamTokenTypeTable
{
		...
		CFBamTokenTypeBuff Buff )
	{
		...
		if( "a849".equals( Buff.getClassCode() )
