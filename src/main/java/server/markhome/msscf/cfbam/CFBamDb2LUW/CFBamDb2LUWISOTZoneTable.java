// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ISOTZone.
...
/*
 *	CFBamDb2LUWISOTZoneTable DB/2 LUW Jdbc DbIO implementation
 *	for ISOTZone.
 */
public class CFBamDb2LUWISOTZoneTable
	implements ICFBamISOTZoneTable
{
	...
	public CFBamDb2LUWISOTZoneTable( CFBamDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOTZoneBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOTZoneId )
	{
		final String S_ProcName = "CFBamDb2LUWISOTZoneTable.readDerivedByIdIdx() ";
		CFSecISOTZoneBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOTZoneBuff readDerivedByUTZNameIdx( CFSecAuthorization Authorization,
		String TZName )
	{
		final String S_ProcName = "CFBamDb2LUWISOTZoneTable.readDerivedByUTZNameIdx() ";
		CFSecISOTZoneBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFSecISOTZoneBuff Buff )
	{
		...
		if( "a008".equals( Buff.getClassCode() )
			&& ( ! schema.isSystemUser( Authorization ) ) )
		{
			throw new CFLibRuntimeException( getClass(),
				S_ProcName,
				"Permission denied -- only system user can modify ISOTZone data" );
		}
		ResultSet resultSet = null;
		try {
