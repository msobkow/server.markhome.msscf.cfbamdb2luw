// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ServerListFunc.
...
/*
 *	CFBamDb2LUWServerListFuncTable DB/2 LUW Jdbc DbIO implementation
 *	for ServerListFunc.
 */
	...
	implements ICFBamServerListFuncTable
{
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_srvlfunc_by_methtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamServerListFuncBuff Buff )
	{
		...
		if( "a837".equals( Buff.getClassCode() )
		...
		long argTableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_srvlfunc_by_methtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
