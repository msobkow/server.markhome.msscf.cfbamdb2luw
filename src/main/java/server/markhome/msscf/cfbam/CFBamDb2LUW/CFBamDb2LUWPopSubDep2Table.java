// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for PopSubDep2.
...
/*
 *	CFBamDb2LUWPopSubDep2Table DB/2 LUW Jdbc DbIO implementation
 *	for PopSubDep2.
 */
	...
	implements ICFBamPopSubDep2Table
{
		...
		long PopSubDep1Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_popsubdep2_by_popsubdep1idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamPopSubDep2Buff Buff )
	{
		...
		if( "a832".equals( Buff.getClassCode() )
		...
		long argPopSubDep1Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_popsubdep2_by_popsubdep1idx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
