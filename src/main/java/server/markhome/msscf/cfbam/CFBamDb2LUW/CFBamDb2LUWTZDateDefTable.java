// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TZDateDef.
...
/*
 *	CFBamDb2LUWTZDateDefTable DB/2 LUW Jdbc DbIO implementation
 *	for TZDateDef.
 */
	...
	implements ICFBamTZDateDefTable
{
		...
		CFBamTZDateDefBuff Buff )
	{
		...
		if( "a83a".equals( Buff.getClassCode() )
