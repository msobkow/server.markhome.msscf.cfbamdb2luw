// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UInt64Type.
...
/*
 *	CFBamDb2LUWUInt64TypeTable DB/2 LUW Jdbc DbIO implementation
 *	for UInt64Type.
 */
	...
	implements ICFBamUInt64TypeTable
{
		...
		CFBamUInt64TypeBuff Buff )
	{
		...
		if( "a84f".equals( Buff.getClassCode() )
