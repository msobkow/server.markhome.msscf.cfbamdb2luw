// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ServiceType.
...
/*
 *	CFBamDb2LUWServiceTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for ServiceType.
 */
	...
	implements ICFBamServiceTypeTable
{
		...
		CFSecServiceTypeBuff Buff )
	{
		...
		if( "a013".equals( Buff.getClassCode() )
