// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TZTimestampCol.
...
/*
 *	CFBamDb2LUWTZTimestampColTable DB/2 LUW Jdbc DbIO implementation
 *	for TZTimestampCol.
 */
	...
	implements ICFBamTZTimestampColTable
{
		...
		CFBamTZTimestampColBuff Buff )
	{
		...
		if( "a865".equals( Buff.getClassCode() )
