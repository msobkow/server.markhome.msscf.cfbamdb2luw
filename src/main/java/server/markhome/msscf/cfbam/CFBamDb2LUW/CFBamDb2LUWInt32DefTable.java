// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Int32Def.
...
/*
 *	CFBamDb2LUWInt32DefTable DB/2 LUW Jdbc DbIO implementation
 *	for Int32Def.
 */
	...
	implements ICFBamInt32DefTable
{
		...
		CFBamInt32DefBuff Buff )
	{
		...
		if( "a825".equals( Buff.getClassCode() )
