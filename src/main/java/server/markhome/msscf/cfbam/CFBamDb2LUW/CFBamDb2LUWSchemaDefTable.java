// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for SchemaDef.
...
/*
 *	CFBamDb2LUWSchemaDefTable DB/2 LUW Jdbc DbIO implementation
 *	for SchemaDef.
 */
	...
	implements ICFBamSchemaDefTable
{
		...
		long MinorVersionId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_schemadef_by_minorversionidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		String AuthorEMail )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_schemadef_by_authemailidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		String ProjectURL )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_schemadef_by_projecturlidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamSchemaDefBuff Buff )
	{
		...
		if( "a802".equals( Buff.getClassCode() )
		...
		long argMinorVersionId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_schemadef_by_minorversionidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		String argAuthorEMail )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_schemadef_by_authemailidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		String argProjectURL )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_schemadef_by_projecturlidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
