// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for MajorVersion.
...
/*
 *	CFBamDb2LUWMajorVersionTable DB/2 LUW Jdbc DbIO implementation
 *	for MajorVersion.
 */
	...
	implements ICFBamMajorVersionTable
{
		...
		CFIntMajorVersionPKey PKey )
	{
		...
		try {
			...
			final String sql = "CALL sp_read_mjvrdef( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFIntMajorVersionPKey PKey )
	{
		...
		try {
			...
			long TenantId = PKey.getRequiredTenantId();
			long Id = PKey.getRequiredId();
			final String sql = "CALL sp_lock_mjvrdef( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
	...
	public CFIntMajorVersionBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mjvrdef_all( ?, ?, ?, ?, ? )";
		...
		long Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mjvrdef_by_ididx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long TenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mjvrdef_by_tenantidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + " )";
		...
		long SubProjectId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mjvrdef_by_subprojectidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		String Name )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_mjvrdef_by_nameidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFIntMajorVersionBuff Buff )
	{
		...
		if( "a102".equals( Buff.getClassCode() )
		...
		CFIntMajorVersionBuff Buff )
	{
		...
		try {
			...
			final String sql = "CALL sp_delete_mjvrdef( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_mjvrdef_by_ididx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argTenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_mjvrdef_by_tenantidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + " )";
		...
		long argSubProjectId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_mjvrdef_by_subprojectidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		String argName )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_mjvrdef_by_nameidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
