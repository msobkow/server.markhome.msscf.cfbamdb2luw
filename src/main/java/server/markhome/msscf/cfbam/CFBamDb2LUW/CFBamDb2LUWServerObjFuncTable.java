// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ServerObjFunc.
...
/*
 *	CFBamDb2LUWServerObjFuncTable DB/2 LUW Jdbc DbIO implementation
 *	for ServerObjFunc.
 */
	...
	implements ICFBamServerObjFuncTable
{
		...
		long TableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_srvofunc_by_methtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamServerObjFuncBuff Buff )
	{
		...
		if( "a806".equals( Buff.getClassCode() )
		...
		long argTableId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_srvofunc_by_methtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
