// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Int64Type.
...
/*
 *	CFBamDb2LUWInt64TypeTable DB/2 LUW Jdbc DbIO implementation
 *	for Int64Type.
 */
	...
	implements ICFBamInt64TypeTable
{
		...
		CFBamInt64TypeBuff Buff )
	{
		...
		if( "a828".equals( Buff.getClassCode() )
