// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for SecGrpInc.
...
/*
 *	CFBamDb2LUWSecGrpIncTable DB/2 LUW Jdbc DbIO implementation
 *	for SecGrpInc.
 */
public class CFBamDb2LUWSecGrpIncTable
	implements ICFBamSecGrpIncTable
{
	...
	public CFBamDb2LUWSecGrpIncTable( CFBamDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpIncId )
	{
		final String S_ProcName = "CFBamDb2LUWSecGrpIncTable.readDerivedByIdIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFBamDb2LUWSecGrpIncTable.readDerivedByUIncludeIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		Long priorSecGrpIncId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_page_secinc_all( ?, ?, ?, ?, ?, ?, ? )";
		...
		Long priorSecGrpIncId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_page_secinc_by_clusteridx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long priorSecGrpIncId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_page_secinc_by_groupidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long priorSecGrpIncId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_page_secinc_by_includeidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFSecSecGrpIncBuff Buff )
	{
		...
		if( "a00e".equals( Buff.getClassCode() )
				...
				"UpdateSecGrpInc" ) ) )
		{
			throw new CFLibRuntimeException( getClass(),
				S_ProcName,
				"Permission denied -- User not part of SecGroup UpdateSecGrpInc" );
		}
		ResultSet resultSet = null;
		try {
			long ClusterId = Buff.getRequiredClusterId();
