// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UuidType.
...
/*
 *	CFBamDb2LUWUuidTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for UuidType.
 */
	...
	implements ICFBamUuidTypeTable
{
		...
		CFBamUuidTypeBuff Buff )
	{
		...
		if( "a851".equals( Buff.getClassCode() )
