// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TimeCol.
...
/*
 *	CFBamDb2LUWTimeColTable DB/2 LUW Jdbc DbIO implementation
 *	for TimeCol.
 */
	...
	implements ICFBamTimeColTable
{
		...
		CFBamTimeColBuff Buff )
	{
		...
		if( "a867".equals( Buff.getClassCode() )
