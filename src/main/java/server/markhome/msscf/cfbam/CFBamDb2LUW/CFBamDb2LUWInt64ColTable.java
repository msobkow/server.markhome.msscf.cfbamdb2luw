// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Int64Col.
...
/*
 *	CFBamDb2LUWInt64ColTable DB/2 LUW Jdbc DbIO implementation
 *	for Int64Col.
 */
	...
	implements ICFBamInt64ColTable
{
		...
		CFBamInt64ColBuff Buff )
	{
		...
		if( "a85e".equals( Buff.getClassCode() )
