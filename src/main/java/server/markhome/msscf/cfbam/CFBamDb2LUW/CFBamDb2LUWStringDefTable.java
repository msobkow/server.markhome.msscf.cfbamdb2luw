// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for StringDef.
...
/*
 *	CFBamDb2LUWStringDefTable DB/2 LUW Jdbc DbIO implementation
 *	for StringDef.
 */
	...
	implements ICFBamStringDefTable
{
		...
		CFBamStringDefBuff Buff )
	{
		...
		if( "a838".equals( Buff.getClassCode() )
