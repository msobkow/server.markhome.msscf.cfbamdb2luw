// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for BoolType.
...
/*
 *	CFBamDb2LUWBoolTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for BoolType.
 */
	...
	implements ICFBamBoolTypeTable
{
		...
		CFBamBoolTypeBuff Buff )
	{
		...
		if( "a80e".equals( Buff.getClassCode() )
