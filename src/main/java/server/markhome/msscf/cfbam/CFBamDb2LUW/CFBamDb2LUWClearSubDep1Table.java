// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for ClearSubDep1.
...
/*
 *	CFBamDb2LUWClearSubDep1Table DB/2 LUW Jdbc DbIO implementation
 *	for ClearSubDep1.
 */
	...
	implements ICFBamClearSubDep1Table
{
		...
		long RelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clrsubdep1_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long DefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clrsubdep1_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long ClearTopDepId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_read_clrsubdep1_by_cleartopdepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		CFBamClearSubDep1Buff Buff )
	{
		...
		if( "a811".equals( Buff.getClassCode() )
		...
		long argClearTopDepId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clrsubdep1_by_cleartopdepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		long argRelationId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clrsubdep1_by_cleardepidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
		...
		Long argDefSchemaId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			final String sql = "CALL sp_delete_clrsubdep1_by_defschemaidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " )";
