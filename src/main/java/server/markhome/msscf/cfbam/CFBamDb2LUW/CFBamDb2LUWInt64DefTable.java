// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Int64Def.
...
/*
 *	CFBamDb2LUWInt64DefTable DB/2 LUW Jdbc DbIO implementation
 *	for Int64Def.
 */
	...
	implements ICFBamInt64DefTable
{
		...
		CFBamInt64DefBuff Buff )
	{
		...
		if( "a827".equals( Buff.getClassCode() )
