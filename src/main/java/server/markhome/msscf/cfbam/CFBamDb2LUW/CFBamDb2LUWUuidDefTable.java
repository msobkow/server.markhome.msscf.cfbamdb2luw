// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UuidDef.
...
/*
 *	CFBamDb2LUWUuidDefTable DB/2 LUW Jdbc DbIO implementation
 *	for UuidDef.
 */
	...
	implements ICFBamUuidDefTable
{
		...
		CFBamUuidDefBuff Buff )
	{
		...
		if( "a850".equals( Buff.getClassCode() )
