// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for EnumType.
...
/*
 *	CFBamDb2LUWEnumTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for EnumType.
 */
	...
	implements ICFBamEnumTypeTable
{
		...
		CFBamEnumTypeBuff Buff )
	{
		...
		if( "a857".equals( Buff.getClassCode() )
