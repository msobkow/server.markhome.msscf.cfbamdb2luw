// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for Int32Col.
...
/*
 *	CFBamDb2LUWInt32ColTable DB/2 LUW Jdbc DbIO implementation
 *	for Int32Col.
 */
	...
	implements ICFBamInt32ColTable
{
		...
		CFBamInt32ColBuff Buff )
	{
		...
		if( "a85d".equals( Buff.getClassCode() )
