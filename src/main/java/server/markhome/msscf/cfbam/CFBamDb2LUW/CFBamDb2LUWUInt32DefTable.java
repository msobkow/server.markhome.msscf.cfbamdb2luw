// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UInt32Def.
...
/*
 *	CFBamDb2LUWUInt32DefTable DB/2 LUW Jdbc DbIO implementation
 *	for UInt32Def.
 */
	...
	implements ICFBamUInt32DefTable
{
		...
		CFBamUInt32DefBuff Buff )
	{
		...
		if( "a84c".equals( Buff.getClassCode() )
