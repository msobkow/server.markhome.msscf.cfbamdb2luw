// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for TZDateCol.
...
/*
 *	CFBamDb2LUWTZDateColTable DB/2 LUW Jdbc DbIO implementation
 *	for TZDateCol.
 */
	...
	implements ICFBamTZDateColTable
{
		...
		CFBamTZDateColBuff Buff )
	{
		...
		if( "a863".equals( Buff.getClassCode() )
