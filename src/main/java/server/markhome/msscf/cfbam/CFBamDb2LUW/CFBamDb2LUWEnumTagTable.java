// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for EnumTag.
...
/*
 *	CFBamDb2LUWEnumTagTable DB/2 LUW Jdbc DbIO implementation
 *	for EnumTag.
 */
	...
	implements ICFBamEnumTagTable
{
		...
		CFBamEnumTagBuff Buff )
	{
		...
		if( "a81e".equals( Buff.getClassCode() )
