// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for UuidCol.
...
/*
 *	CFBamDb2LUWUuidColTable DB/2 LUW Jdbc DbIO implementation
 *	for UuidCol.
 */
	...
	implements ICFBamUuidColTable
{
		...
		CFBamUuidColBuff Buff )
	{
		...
		if( "a86d".equals( Buff.getClassCode() )
