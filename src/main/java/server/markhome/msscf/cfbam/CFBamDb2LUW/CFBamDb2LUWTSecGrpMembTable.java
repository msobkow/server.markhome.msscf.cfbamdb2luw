...
/*
 *	CFBamDb2LUWTSecGrpMembTable DB/2 LUW Jdbc DbIO implementation
 *	for TSecGrpMemb.
 */
public class CFBamDb2LUWTSecGrpMembTable
	implements ICFBamTSecGrpMembTable
{
	...
	public CFBamDb2LUWTSecGrpMembTable( CFBamDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpMembId )
	{
		final String S_ProcName = "CFBamDb2LUWTSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFBamDb2LUWTSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
