// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for FloatDef.
...
/*
 *	CFBamDb2LUWFloatDefTable DB/2 LUW Jdbc DbIO implementation
 *	for FloatDef.
 */
	...
	implements ICFBamFloatDefTable
{
		...
		CFBamFloatDefBuff Buff )
	{
		...
		if( "a81f".equals( Buff.getClassCode() )
